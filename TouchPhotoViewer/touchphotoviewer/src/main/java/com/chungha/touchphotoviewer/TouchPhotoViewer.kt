package com.chungha.touchphotoviewer
...
@Suppress("unused")
open class TouchPhotoViewer @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyle: Int = 0) :
     ...
     * and ScaleType.
     */
    fun setZoom(img: TouchPhotoViewer) {
